...
Write-Host "Setting up Vercel aliases for all projects..." -ForegroundColor Cyan
Write-Host ""
...
Write-Host "VERCEL ALIAS SETUP COMPLETE" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "All projects now have aliases in the format:" -ForegroundColor White
